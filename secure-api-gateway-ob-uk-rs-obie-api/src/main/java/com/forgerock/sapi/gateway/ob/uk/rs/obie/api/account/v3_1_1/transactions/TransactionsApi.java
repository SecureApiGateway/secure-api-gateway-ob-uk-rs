 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.account.v3_1_1.transactions;
...
public interface TransactionsApi {
    ...
    @ApiOperation(value = "Get Statement Transactions", nickname = "getAccountStatementTransactions",
            notes = "Get Statement Transactions related to an account", response = OBReadTransaction5.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "accounts", description = "Ability to get Accounts information")
            })
    })
