...
public interface InternationalStandingOrderConsentsApi {
     ...
     * @param obWriteInternationalStandingOrderConsent6 Default (required)
     ...
     * @return International Standing Order Consents Created (status code 201)
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "201", description = "International Standing Order Consents Created", content = {
                            @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteInternationalStandingOrderConsentResponse7.class)),
                            @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteInternationalStandingOrderConsentResponse7.class)),
                            @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteInternationalStandingOrderConsentResponse7.class))
                    }),
    ...
    ResponseEntity<OBWriteInternationalStandingOrderConsentResponse7> createInternationalStandingOrderConsents(
            ...
            @Parameter(name = "OBWriteInternationalStandingOrderConsent6", description = "Default", required = true) @Valid @RequestBody OBWriteInternationalStandingOrderConsent6 obWriteInternationalStandingOrderConsent6,
     ...
     * @param xCustomerUserAgent     Indicates the user-agent that the PSU is using. (optional)
     * @param apiClientId            OAuth2.0 client_id of the ApiClient making the request
     * @return International Standing Order Consents Read (status code 200)
     * or Bad request (status code 400)
     * or Unauthorized (status code 401)
     * or Forbidden (status code 403)
     * or Not found (status code 404)
    ...
    @Operation(
            ...
            tags = {"International Standing Orders"},
            responses = {
                    @ApiResponse(responseCode = "200", description = "International Standing Order Consents Read", content = {
                            @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteInternationalStandingOrderConsentResponse7.class)),
                            @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteInternationalStandingOrderConsentResponse7.class)),
                            @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteInternationalStandingOrderConsentResponse7.class))
                    }),
    ...
    @RequestMapping(
            ...
            value = "/international-standing-order-consents/{ConsentId}",
            produces = {"application/json; charset=utf-8", "application/json", "application/jose+jwe"}
    )
