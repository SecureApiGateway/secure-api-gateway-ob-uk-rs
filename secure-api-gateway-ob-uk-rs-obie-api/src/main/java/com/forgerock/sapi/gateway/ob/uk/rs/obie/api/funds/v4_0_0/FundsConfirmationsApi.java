...
public interface FundsConfirmationsApi {
     ...
     * @param obFundsConfirmation1 Default (required)
     ...
     * @return Funds Confirmation Created (status code 201)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Funds Confirmation Created", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBFundsConfirmationResponse1.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBFundsConfirmationResponse1.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBFundsConfirmationResponse1.class))
            }),
        ...
        security = {
            @SecurityRequirement(name = "PSUOAuth2Security", scopes={ "fundsconfirmations" })
        }
    )
    @RequestMapping(
        method = RequestMethod.POST,
        value = "/funds-confirmations",
    ...
    ResponseEntity<OBFundsConfirmationResponse1> createFundsConfirmations(
        ...
        @Parameter(name = "OBFundsConfirmation1", description = "Default", required = true) @Valid @RequestBody OBFundsConfirmation1 obFundsConfirmation1,
