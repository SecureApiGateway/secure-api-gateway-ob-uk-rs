 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_1.internationalpayments;
...
public interface InternationalPaymentsApi {
    ...
    @ApiOperation(value = "Create International Payments", nickname = "createInternationalPayments", notes = "", response = OBWriteInternationalResponse2.class, authorizations = {
    ...
    ResponseEntity<OBWriteInternationalResponse2> createInternationalPayments(
    ...
    @ApiOperation(value = "Get International Payments", nickname = "getInternationalPaymentsInternationalPaymentId", notes = "", response = OBWriteInternationalResponse2.class, authorizations = {
