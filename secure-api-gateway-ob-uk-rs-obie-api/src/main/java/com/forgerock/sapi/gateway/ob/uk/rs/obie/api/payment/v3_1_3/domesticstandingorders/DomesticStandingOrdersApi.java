 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_1_3.domesticstandingorders;
...
public interface DomesticStandingOrdersApi {
    ...
    @ApiOperation(value = "Create Domestic Standing Orders", nickname = "createDomesticStandingOrders", notes = "", response = OBWriteDomesticStandingOrderResponse4.class, authorizations = {
    ...
    ResponseEntity<OBWriteDomesticStandingOrderResponse4> createDomesticStandingOrders(
    ...
    @ApiOperation(value = "Get Domestic Standing Orders", nickname = "getDomesticStandingOrdersDomesticStandingOrderId", notes = "", response = OBWriteDomesticStandingOrderResponse4.class, authorizations = {
