...
public interface InternationalPaymentConsentsApi {
     ...
     * @param obWriteInternationalConsent5 Default (required)
     ...
     * @return International Payment Consents Created (status code 201)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "International Payment Consents Created", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteInternationalConsentResponse6.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteInternationalConsentResponse6.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteInternationalConsentResponse6.class))
            }),
    ...
    ResponseEntity<OBWriteInternationalConsentResponse6> createInternationalPaymentConsents(
        ...
        @Parameter(name = "OBWriteInternationalConsent5", description = "Default", required = true) @Valid @RequestBody OBWriteInternationalConsent5 obWriteInternationalConsent5,
     ...
     * @param xFapiInteractionId An RFC4122 UID used as a correlation id. (optional)
     * @param xCustomerUserAgent Indicates the user-agent that the PSU is using. (optional)
     * @return International Payment Consents Read (status code 200)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
     *         or Forbidden (status code 403)
     *         or Not found (status code 404)
    ...
    @Operation(
        ...
        tags = { "International Payments" },
        responses = {
            @ApiResponse(responseCode = "200", description = "International Payment Consents Read", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteInternationalConsentResponse6.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteInternationalConsentResponse6.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteInternationalConsentResponse6.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/international-payment-consents/{ConsentId}",
        produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/international-payment-consents/{ConsentId}/funds-confirmation",
        produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" }
    )
