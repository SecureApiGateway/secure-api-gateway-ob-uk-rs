 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_0.domesticscheduledpayments;
...
public interface DomesticScheduledPaymentsApi {
    ...
    @ApiOperation(value = "Create Domestic Scheduled Payments", nickname = "createDomesticScheduledPayments", notes = "", response = OBWriteDomesticScheduledResponse1.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Scheduled Payments Created", response = OBWriteDomesticScheduledResponse1.class),
    ...
    ResponseEntity<OBWriteDomesticScheduledResponse1> createDomesticScheduledPayments(
    ...
    @ApiOperation(value = "Get Domestic Scheduled Payments", nickname = "getDomesticScheduledPaymentsDomesticScheduledPaymentId", notes = "", response = OBWriteDomesticScheduledResponse1.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Scheduled Payments Read", response = OBWriteDomesticScheduledResponse1.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
    ...
    ResponseEntity<OBWriteDomesticScheduledResponse1> getDomesticScheduledPaymentsDomesticScheduledPaymentId(
