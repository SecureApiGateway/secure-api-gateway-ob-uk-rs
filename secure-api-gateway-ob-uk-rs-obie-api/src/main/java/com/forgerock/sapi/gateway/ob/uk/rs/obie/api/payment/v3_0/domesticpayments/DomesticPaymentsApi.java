 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_0.domesticpayments;
...
public interface DomesticPaymentsApi {
    ...
    @ApiOperation(value = "Create Domestic Payments", nickname = "createDomesticPayments", notes = "", response = OBWriteDomesticResponse1.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Payments Created", response = OBWriteDomesticResponse1.class),
    ...
    ResponseEntity<OBWriteDomesticResponse1> createDomesticPayments(
            @ApiParam(value = "The domestic payment resource", required = true)
            @Valid
    ...
    @ApiOperation(value = "Get Domestic Payments", nickname = "getDomesticPaymentsDomesticPaymentId", notes = "", response = OBWriteDomesticResponse1.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Payments Read", response = OBWriteDomesticResponse1.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 405, message = "Method Not Allowed"),
    ...
    ResponseEntity<OBWriteDomesticResponse1> getDomesticPaymentsDomesticPaymentId(
