 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.account.v3_0.beneficiaries;
...
public interface BeneficiariesApi {
    ...
    @ApiOperation(value = "Get Account Beneficiaries", notes = "Get Beneficiaries related to an account",
            response = OBReadBeneficiary2.class, authorizations = {
    ...
    @ApiOperation(value = "Get Beneficiaries", notes = "Get Beneficiaries", response = OBReadBeneficiary2.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "accounts", description = "Ability to get Accounts information")
            })
    })
