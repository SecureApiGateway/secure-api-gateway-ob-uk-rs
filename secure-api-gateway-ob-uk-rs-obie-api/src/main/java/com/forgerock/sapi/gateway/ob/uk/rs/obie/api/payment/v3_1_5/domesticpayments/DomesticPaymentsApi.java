...
public interface DomesticPaymentsApi {
    ...
    @ApiOperation(value = "Create Domestic Payments", nickname = "createDomesticPayments", notes = "", response = OBWriteDomesticResponse5.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Payments Created", response = OBWriteDomesticResponse5.class),
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Payments Read", response = OBWriteDomesticResponse5.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 404, message = "Not found"),
