...
@Validated
@Tag(name = "Domestic Standing Orders", description = "the Domestic Standing Orders API")
...
public interface DomesticStandingOrderConsentsApi {
     ...
     * @param obWriteDomesticStandingOrderConsent5 Default (required)
     ...
     * @return Domestic Standing Order Consents Created (status code 201)
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "201", description = "Domestic Standing Order Consents Created", content = {
                            @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteDomesticStandingOrderConsentResponse6.class)),
                            @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteDomesticStandingOrderConsentResponse6.class)),
                            @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteDomesticStandingOrderConsentResponse6.class))
                    }),
    ...
    ResponseEntity<OBWriteDomesticStandingOrderConsentResponse6> createDomesticStandingOrderConsents(
            ...
            @Parameter(name = "OBWriteDomesticStandingOrderConsent5", description = "Default", required = true) @Valid @RequestBody OBWriteDomesticStandingOrderConsent5 obWriteDomesticStandingOrderConsent5,
     ...
     * @param xCustomerUserAgent     Indicates the user-agent that the PSU is using. (optional)
     * @param apiClientId            OAuth2.0 client_id of the ApiClient making the request
     * @return Domestic Standing Order Consents Read (status code 200)
     * or Bad request (status code 400)
     * or Unauthorized (status code 401)
     * or Forbidden (status code 403)
     * or Not found (status code 404)
    ...
    @Operation(
            ...
            tags = {"Domestic Standing Orders"},
            responses = {
                    @ApiResponse(responseCode = "200", description = "Domestic Standing Order Consents Read", content = {
                            @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteDomesticStandingOrderConsentResponse6.class)),
                            @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteDomesticStandingOrderConsentResponse6.class)),
                            @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteDomesticStandingOrderConsentResponse6.class))
                    }),
    ...
    @RequestMapping(
            ...
            value = "/domestic-standing-order-consents/{ConsentId}",
            produces = {"application/json; charset=utf-8", "application/json", "application/jose+jwe"}
    )
    ResponseEntity<OBWriteDomesticStandingOrderConsentResponse6> getDomesticStandingOrderConsentsConsentId(
