 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.account.v3_1_10.accounts;
...
@Api(tags = "v3.1.10", description = "the account-access-consents API")
...
public interface AccountAccessConsentsApi {
    ...
    }, tags = {"CreateAccountAccessConsent",})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Delete Account Access Consents", nickname = "deleteAccountAccessConsent", notes = "Delete an account Access Consent",
            ...
            }, tags = {"DeleteAccountAccessConsent",})
    @ApiResponses(value = {
