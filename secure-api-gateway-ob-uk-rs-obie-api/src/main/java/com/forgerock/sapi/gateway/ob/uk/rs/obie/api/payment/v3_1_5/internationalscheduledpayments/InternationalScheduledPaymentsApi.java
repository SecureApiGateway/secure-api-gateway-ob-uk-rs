 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_1_5.internationalscheduledpayments;
...
public interface InternationalScheduledPaymentsApi {
    ...
    @ApiOperation(value = "Create International Scheduled Payments", nickname = "createInternationalScheduledPayments", notes = "", response = OBWriteInternationalScheduledResponse6.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "International Scheduled Payments Created", response = OBWriteInternationalScheduledResponse6.class),
    ...
    @ApiOperation(value = "Get International Scheduled Payments", nickname = "getInternationalScheduledPaymentsInternationalScheduledPaymentId", notes = "", response = OBWriteInternationalScheduledResponse6.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "International Scheduled Payments Read", response = OBWriteInternationalScheduledResponse6.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 404, message = "Not found"),
