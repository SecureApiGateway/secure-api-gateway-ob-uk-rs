 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_1.domesticpayments;
...
public interface DomesticPaymentsApi {
    ...
    @ApiOperation(value = "Create Domestic Payments", nickname = "createDomesticPayments", notes = "", response = OBWriteDomesticResponse2.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Payments Created", response = OBWriteDomesticResponse2.class),
    ...
    ResponseEntity<OBWriteDomesticResponse2> createDomesticPayments(
    ...
    @ApiOperation(value = "Get Domestic Payments", nickname = "getDomesticPaymentsDomesticPaymentId", notes = "", response = OBWriteDomesticResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Payments Read", response = OBWriteDomesticResponse2.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 405, message = "Method Not Allowed"),
