 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.funds.v4_0_0;
...
@Validated
@Tag(name = "Funds Confirmations", description = "the Funds Confirmations API")
@RequestMapping(value = "/open-banking/v4.0.0/cbpii")
public interface FundsConfirmationConsentsApi {
     ...
     * @param obFundsConfirmationConsent1 Default (required)
     ...
     * @return Funds Confirmation Consent Created (status code 201)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Funds Confirmation Consent Created", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBFundsConfirmationConsentResponse1.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBFundsConfirmationConsentResponse1.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBFundsConfirmationConsentResponse1.class))
            }),
        ...
        security = {
            @SecurityRequirement(name = "TPPOAuth2Security", scopes={ "fundsconfirmations" })
        }
    )
    @RequestMapping(
        method = RequestMethod.POST,
        value = "/funds-confirmation-consents",
        produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
        consumes = { "application/json" }
    )
    
    ResponseEntity<OBFundsConfirmationConsentResponse1> createFundsConfirmationConsents(
        ...
        @Parameter(name = "OBFundsConfirmationConsent1", description = "Default", required = true) @Valid @RequestBody OBFundsConfirmationConsent1 obFundsConfirmationConsent1,
     ...
     * @param xFapiInteractionId An RFC4122 UID used as a correlation id. (optional)
     * @param xCustomerUserAgent Indicates the user-agent that the PSU is using. (optional)
     * @return Funds Confirmation Consent Deleted (status code 204)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
     *         or Forbidden (status code 403)
     *         or Method Not Allowed (status code 405)
    ...
    @Operation(
        ...
        tags = { "Funds Confirmations" },
        responses = {
            @ApiResponse(responseCode = "204", description = "Funds Confirmation Consent Deleted"),
            @ApiResponse(responseCode = "400", description = "Bad request", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBErrorResponse1.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBErrorResponse1.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBErrorResponse1.class))
    ...
    @RequestMapping(
        ...
        value = "/funds-confirmation-consents/{ConsentId}",
        produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" }
    )
     ...
     * @param xFapiInteractionId An RFC4122 UID used as a correlation id. (optional)
     * @param xCustomerUserAgent Indicates the user-agent that the PSU is using. (optional)
     * @return Funds Confirmation Consent Read (status code 200)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
     *         or Forbidden (status code 403)
     *         or Method Not Allowed (status code 405)
    ...
    @Operation(
        ...
        tags = { "Funds Confirmations" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Funds Confirmation Consent Read", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBFundsConfirmationConsentResponse1.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBFundsConfirmationConsentResponse1.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBFundsConfirmationConsentResponse1.class))
            }),
