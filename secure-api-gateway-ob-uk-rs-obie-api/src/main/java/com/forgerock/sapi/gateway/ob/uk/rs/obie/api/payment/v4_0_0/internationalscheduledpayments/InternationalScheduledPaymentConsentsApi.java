...
public interface InternationalScheduledPaymentConsentsApi {
     ...
     * @param obWriteInternationalScheduledConsent5 Default (required)
     ...
     * @return International Scheduled Payment Consents Created (status code 201)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "International Scheduled Payment Consents Created", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteInternationalScheduledConsentResponse6.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteInternationalScheduledConsentResponse6.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteInternationalScheduledConsentResponse6.class))
            }),
    ...
    ResponseEntity<OBWriteInternationalScheduledConsentResponse6> createInternationalScheduledPaymentConsents(
        ...
        @Parameter(name = "OBWriteInternationalScheduledConsent5", description = "Default", required = true) @Valid @RequestBody OBWriteInternationalScheduledConsent5 obWriteInternationalScheduledConsent5,
     ...
     * @param xCustomerUserAgent Indicates the user-agent that the PSU is using. (optional)
     * @param apiClientId OAuth2.0 client_id of the ApiClient making the request
     * @return International Scheduled Payment Consents Read (status code 200)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
     *         or Forbidden (status code 403)
     *         or Not found (status code 404)
    ...
    @Operation(
        ...
        tags = { "International Scheduled Payments" },
        responses = {
            @ApiResponse(responseCode = "200", description = "International Scheduled Payment Consents Read", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteInternationalScheduledConsentResponse6.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteInternationalScheduledConsentResponse6.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteInternationalScheduledConsentResponse6.class))
            }),
