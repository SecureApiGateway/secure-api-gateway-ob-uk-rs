 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_0.internationalscheduledpayments;
...
public interface InternationalScheduledPaymentsApi {
    ...
    @ApiOperation(value = "Create International Scheduled Payments", nickname = "createInternationalScheduledPayments", notes = "", response = OBWriteInternationalScheduledResponse1.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "International Scheduled Payments Created", response = OBWriteInternationalScheduledResponse1.class),
    ...
    ResponseEntity<OBWriteInternationalScheduledResponse1> createInternationalScheduledPayments(
    ...
    @ApiOperation(value = "Get International Scheduled Payments", nickname = "getInternationalScheduledPaymentsInternationalScheduledPaymentId", notes = "", response = OBWriteInternationalScheduledResponse1.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "International Scheduled Payments Read", response = OBWriteInternationalScheduledResponse1.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
    ...
    ResponseEntity<OBWriteInternationalScheduledResponse1> getInternationalScheduledPaymentsInternationalScheduledPaymentId(
