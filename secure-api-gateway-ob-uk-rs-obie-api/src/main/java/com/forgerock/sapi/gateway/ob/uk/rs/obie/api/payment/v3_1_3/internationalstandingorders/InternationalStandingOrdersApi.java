 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_1_3.internationalstandingorders;
...
public interface InternationalStandingOrdersApi {
    ...
    @ApiOperation(value = "Create International Standing Orders", nickname = "createInternationalStandingOrders", notes = "", response = OBWriteInternationalStandingOrderResponse5.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "International Standing Orders Created", response = OBWriteInternationalStandingOrderResponse5.class),
    ...
    ResponseEntity<OBWriteInternationalStandingOrderResponse5> createInternationalStandingOrders(
            ...
            @ApiParam(value = "The ID of the account that the standing order is being made from.")
    ...
    @ApiOperation(value = "Get International Standing Orders", nickname = "getInternationalStandingOrdersInternationalStandingOrderPaymentId", notes = "", response = OBWriteInternationalStandingOrderResponse5.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "International Standing Orders Read", response = OBWriteInternationalStandingOrderResponse5.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 404, message = "Not found"),
