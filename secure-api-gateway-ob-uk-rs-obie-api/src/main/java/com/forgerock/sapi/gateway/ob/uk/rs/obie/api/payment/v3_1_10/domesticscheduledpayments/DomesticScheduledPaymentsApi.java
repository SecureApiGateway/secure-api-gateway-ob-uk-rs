...
public interface DomesticScheduledPaymentsApi {
    ...
    @ApiOperation(value = "Create Domestic Scheduled Payments", nickname = "createDomesticScheduledPayments", notes = "", response = OBWriteDomesticScheduledResponse5.class, authorizations = {
