 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.account.v3_0.statements;
...
public interface StatementsApi {
    ...
    ResponseEntity<OBReadStatement1> getStatements(
            ...
            @RequestParam(value = ApiConstants.ParametersFieldName.FROM_STATEMENT_DATE_TIME, required = false) DateTime fromStatementDateTime,

            @ApiParam(value = "The UTC ISO 8601 Date Time to filter statements TO  NB Time component is optional " +
                    "- set to 00:00:00 for just Date.   The parameter must NOT have a timezone set")
            @RequestParam(value = ApiConstants.ParametersFieldName.TO_STATEMENT_DATE_TIME, required = false) DateTime toStatementDateTime,
