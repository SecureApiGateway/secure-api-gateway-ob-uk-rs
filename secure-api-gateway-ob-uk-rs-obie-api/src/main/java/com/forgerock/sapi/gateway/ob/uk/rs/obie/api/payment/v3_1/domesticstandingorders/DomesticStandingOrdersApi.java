 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.obie.api.payment.v3_1.domesticstandingorders;
...
public interface DomesticStandingOrdersApi {
    ...
    @ApiOperation(value = "Create Domestic Standing Orders", nickname = "createDomesticStandingOrders", notes = "", response = OBWriteDomesticStandingOrderResponse2.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Standing Orders Created", response = OBWriteDomesticStandingOrderResponse2.class),
    ...
    ResponseEntity<OBWriteDomesticStandingOrderResponse2> createDomesticStandingOrders(
    ...
    @ApiOperation(value = "Get Domestic Standing Orders", nickname = "getDomesticStandingOrdersDomesticStandingOrderId", notes = "", response = OBWriteDomesticStandingOrderResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Standing Orders Read", response = OBWriteDomesticStandingOrderResponse2.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
