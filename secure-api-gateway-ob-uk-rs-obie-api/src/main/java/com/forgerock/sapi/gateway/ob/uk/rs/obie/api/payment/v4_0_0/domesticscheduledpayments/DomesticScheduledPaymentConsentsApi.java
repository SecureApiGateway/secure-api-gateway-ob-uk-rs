...
public interface DomesticScheduledPaymentConsentsApi {
     ...
     * @param obWriteDomesticScheduledConsent4 Default (required)
     ...
     * @return Domestic Scheduled Payment Consents Created (status code 201)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Domestic Scheduled Payment Consents Created", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteDomesticScheduledConsentResponse5.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteDomesticScheduledConsentResponse5.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteDomesticScheduledConsentResponse5.class))
            }),
    ...
    ResponseEntity<OBWriteDomesticScheduledConsentResponse5> createDomesticScheduledPaymentConsents(
        ...
        @Parameter(name = "OBWriteDomesticScheduledConsent4", description = "Default", required = true) @Valid @RequestBody OBWriteDomesticScheduledConsent4 obWriteDomesticScheduledConsent4,
     ...
     * @param xCustomerUserAgent Indicates the user-agent that the PSU is using. (optional)
     * @param apiClientId OAuth2.0 client_id of the ApiClient making the request
     * @return Domestic Scheduled Payment Consents Read (status code 200)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
     *         or Forbidden (status code 403)
     *         or Not found (status code 404)
    ...
    @Operation(
        ...
        tags = { "Domestic Scheduled Payments" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Domestic Scheduled Payment Consents Read", content = {
                @Content(mediaType = "application/json; charset=utf-8", schema = @Schema(implementation = OBWriteDomesticScheduledConsentResponse5.class)),
                @Content(mediaType = "application/json", schema = @Schema(implementation = OBWriteDomesticScheduledConsentResponse5.class)),
                @Content(mediaType = "application/jose+jwe", schema = @Schema(implementation = OBWriteDomesticScheduledConsentResponse5.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/domestic-scheduled-payment-consents/{ConsentId}",
        produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" }
    )
