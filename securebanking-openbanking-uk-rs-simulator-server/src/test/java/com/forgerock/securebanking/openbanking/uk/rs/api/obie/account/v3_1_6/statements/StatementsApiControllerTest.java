...
public class StatementsApiControllerTest {
    ...
    private static final String ACCOUNT_STATEMENTS_URI = "/open-banking/v3.1.6/aisp/accounts/{AccountId}/statements";
    private static final String STATEMENTS_URI = "/open-banking/v3.1.6/aisp/statements";
