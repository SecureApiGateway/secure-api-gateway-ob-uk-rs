...
public class OffersApiControllerTest {
    ...
    private static final String ACCOUNT_OFFERS_URI = "/open-banking/v3.0/aisp/accounts/{AccountId}/offers";
    private static final String OFFERS_URI = "/open-banking/v3.0/aisp/offers";
