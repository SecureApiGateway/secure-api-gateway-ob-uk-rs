...
import static uk.org.openbanking.testsupport.payment.OBWriteInternationalConsentTestDataFactory.*;

/**
 * Unit test for {@link InternationalPaymentConsentValidation}
 */
public class InternationalPaymentConsentValidationTest {
    private PaymentConsentValidation validation;
    private OBWriteInternationalConsent3 consent3;

    @BeforeEach
    public void setup() {
        validation = new InternationalPaymentConsentValidation();
        consent3 = aValidOBWriteInternationalConsent3();
    }

    private static Stream<Arguments> provideConsent() {
        return Stream.of(
                Arguments.arguments(aValidOBWriteInternationalConsent3()),
                Arguments.arguments(aValidOBWriteInternationalConsent4()),
                Arguments.arguments(aValidOBWriteInternationalConsent5())
        );
    }
