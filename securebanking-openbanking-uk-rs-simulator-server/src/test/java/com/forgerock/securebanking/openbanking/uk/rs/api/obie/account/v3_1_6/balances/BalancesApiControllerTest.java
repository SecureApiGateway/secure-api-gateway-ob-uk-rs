...
public class BalancesApiControllerTest {
    ...
    private static final String ACCOUNT_BALANCES_URI = "/open-banking/v3.1.6/aisp/accounts/{AccountId}/balances";
    private static final String BALANCES_URI = "/open-banking/v3.1.6/aisp/balances";
