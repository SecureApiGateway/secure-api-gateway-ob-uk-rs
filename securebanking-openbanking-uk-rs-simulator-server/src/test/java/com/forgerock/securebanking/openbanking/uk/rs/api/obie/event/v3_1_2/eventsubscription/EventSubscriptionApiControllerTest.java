...
public class EventSubscriptionApiControllerTest {
    ...
    public void shouldCreateEventSubscription() {
        ...
        HttpEntity<OBEventSubscription1> request = new HttpEntity<>(eventSubscription, requiredEventHttpHeaders(eventSubscriptionsUrl(), tppId));
    ...
    public void shouldReadEventSubscription() {
        // Given
        OBEventSubscription1 eventSubscription = aValidOBEventSubscription1();
        HttpHeaders headers = requiredEventHttpHeaders(eventSubscriptionsUrl(), randomUUID().toString());
