...
public class BeneficiariesApiControllerTest {
    ...
    private static final String ACCOUNT_BENEFICIARIES_URI = "/open-banking/v3.0/aisp/accounts/{AccountId}/beneficiaries";
    private static final String BENEFICIARIES_URI = "/open-banking/v3.0/aisp/beneficiaries";
    ...
    public void shouldGetAccountBeneficiaries() {
        ...
        // When
        ResponseEntity<OBReadBeneficiary2> response = restTemplate.exchange(
                url,
                HttpMethod.GET,
                new HttpEntity<>(requiredAccountHttpHeaders(url, accountId)),
                OBReadBeneficiary2.class);
