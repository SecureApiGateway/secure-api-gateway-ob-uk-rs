...
public class DirectDebitsApiControllerTest {
    ...
    private static final String ACCOUNT_DIRECT_DEBIT_URI = "/open-banking/v3.0/aisp/accounts/{AccountId}/direct-debits";
    private static final String DIRECT_DEBIT_URI = "/open-banking/v3.0/aisp/direct-debits";
    ...
    public void shouldGetAccountDirectDebits() {
        ...
        // When
        ResponseEntity<OBReadDirectDebit1> response = restTemplate.exchange(
                url,
                HttpMethod.GET,
                new HttpEntity<>(requiredAccountHttpHeaders(url, accountId)),
                OBReadDirectDebit1.class);

        // Then
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        OBReadDirectDebit1 returnedDirectDebit = response.getBody();
