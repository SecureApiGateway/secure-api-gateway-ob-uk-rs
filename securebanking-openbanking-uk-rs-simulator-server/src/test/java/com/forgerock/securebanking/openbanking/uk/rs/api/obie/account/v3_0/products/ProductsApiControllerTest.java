...
public class ProductsApiControllerTest {
    ...
    private static final String ACCOUNT_PRODUCT_URI = "/open-banking/v3.0/aisp/accounts/{AccountId}/product";
    private static final String PRODUCTS_URI = "/open-banking/v3.0/aisp/products";
