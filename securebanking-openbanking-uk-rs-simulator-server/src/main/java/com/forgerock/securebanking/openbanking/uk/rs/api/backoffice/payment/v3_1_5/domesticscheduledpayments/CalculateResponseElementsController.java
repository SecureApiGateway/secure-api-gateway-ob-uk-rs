 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.v3_1_5.domesticscheduledpayments;
...
import com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.domesticscheduledpayments.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteDomesticScheduledConsentResponse5 calculateElements(
        ...
        try {
            return (OBWriteDomesticScheduledConsentResponse5) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
