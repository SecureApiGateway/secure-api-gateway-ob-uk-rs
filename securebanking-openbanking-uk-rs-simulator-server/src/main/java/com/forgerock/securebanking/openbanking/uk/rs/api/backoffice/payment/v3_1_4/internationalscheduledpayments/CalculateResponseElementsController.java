 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.v3_1_4.internationalscheduledpayments;
...
import com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.internationalscheduledpayments.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteInternationalScheduledConsentResponse5 calculateElements(
        ...
        try {
            return (OBWriteInternationalScheduledConsentResponse5) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
