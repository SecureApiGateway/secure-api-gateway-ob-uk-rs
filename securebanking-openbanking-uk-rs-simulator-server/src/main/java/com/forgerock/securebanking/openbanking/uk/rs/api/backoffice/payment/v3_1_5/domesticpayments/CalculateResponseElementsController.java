...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteDomesticConsentResponse5 calculateElements(
        ...
        try {
            return (OBWriteDomesticConsentResponse5) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
