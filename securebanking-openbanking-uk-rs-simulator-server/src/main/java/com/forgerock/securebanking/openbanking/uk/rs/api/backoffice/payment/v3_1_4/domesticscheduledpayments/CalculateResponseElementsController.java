 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.v3_1_4.domesticscheduledpayments;
...
import com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.domesticscheduledpayments.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public ResponseEntity<OBWriteDomesticScheduledConsentResponse4> calculateElements(
            OBWriteDomesticScheduledConsent4 body,
            String intent,
        ...
        try {
            return ResponseEntity.status(HttpStatus.OK).body((OBWriteDomesticScheduledConsentResponse4) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request));
