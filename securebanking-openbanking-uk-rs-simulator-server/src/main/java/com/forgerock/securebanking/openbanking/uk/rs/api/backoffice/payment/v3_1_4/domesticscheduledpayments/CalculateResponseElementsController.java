...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteDomesticScheduledConsentResponse4 calculateElements(
        ...
        try {
            return (OBWriteDomesticScheduledConsentResponse4) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
