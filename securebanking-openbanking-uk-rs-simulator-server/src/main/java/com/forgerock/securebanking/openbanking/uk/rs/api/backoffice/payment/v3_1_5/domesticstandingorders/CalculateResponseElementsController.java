...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteDomesticStandingOrderConsentResponse6 calculateElements(
        ...
        try {
            return (OBWriteDomesticStandingOrderConsentResponse6) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
