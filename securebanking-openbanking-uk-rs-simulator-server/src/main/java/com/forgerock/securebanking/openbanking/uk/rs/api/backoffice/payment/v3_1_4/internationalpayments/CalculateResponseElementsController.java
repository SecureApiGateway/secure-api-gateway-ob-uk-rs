...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteInternationalConsentResponse5 calculateElements(
        ...
        try {
            return (OBWriteInternationalConsentResponse5) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
