 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.v3_1_4.domesticstandingorders;
...
import com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.domesticstandingorders.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteDomesticStandingOrderConsentResponse5 calculateElements(
        ...
        try {
            return (OBWriteDomesticStandingOrderConsentResponse5) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
