 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.v3_1_4.internationalstandingorders;
...
import com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.internationalstandingorders.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteInternationalStandingOrderConsentResponse6 calculateElements(
        ...
        try {
            return (OBWriteInternationalStandingOrderConsentResponse6) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
