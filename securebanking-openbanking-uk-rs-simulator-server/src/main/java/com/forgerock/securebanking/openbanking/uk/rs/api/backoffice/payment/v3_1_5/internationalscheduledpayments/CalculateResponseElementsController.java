 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.v3_1_5.internationalscheduledpayments;
...
import com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.internationalscheduledpayments.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public ResponseEntity<OBWriteInternationalScheduledConsentResponse6> calculateElements(
        ...
        try {
            return ResponseEntity.status(HttpStatus.OK).body((OBWriteInternationalScheduledConsentResponse6) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request));
