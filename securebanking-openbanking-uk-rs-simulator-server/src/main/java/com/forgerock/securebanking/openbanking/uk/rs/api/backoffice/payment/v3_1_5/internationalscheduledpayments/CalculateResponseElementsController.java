...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    @Override
    public OBWriteInternationalScheduledConsentResponse6 calculateElements(
        ...
        try {
            return (OBWriteInternationalScheduledConsentResponse6) PaymentConsentGeneral.calculate(body, intent, xFapiFinancialId, request);
