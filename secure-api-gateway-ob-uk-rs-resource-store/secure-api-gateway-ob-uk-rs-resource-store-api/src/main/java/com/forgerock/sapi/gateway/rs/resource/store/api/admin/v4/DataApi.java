...
public interface DataApi {
    ...
    @ApiOperation(value = "Returns all Account data", nickname = "exportAccountDataV4",
    ...
    @RequestMapping(value = "/account/v4",
    ...
    @ApiOperation(value = "User has data", nickname = "has-data-V4",
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 429, message = "Too Many Requests"),
            @ApiResponse(code = 500, message = "Internal Server Error")})
    @RequestMapping(value = "/user/has-data/v4", method = RequestMethod.GET)
    ResponseEntity<Boolean> hasData(
            @ApiParam(value = "UserId", required = true)
            @RequestParam("userId") String userId
    );

    @ApiOperation(value = "Export User data", nickname = "exportUserDataV4",
    ...
    @ApiOperation(value = "Update User data", nickname = "updateUserDataV4",
    ...
    @ApiOperation(value = "Import User data", nickname = "importUserDataV4",
    ...
    @ApiOperation(value = "Delete User data", nickname = "deleteUserDataV4",
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 429, message = "Too Many Requests"),
            @ApiResponse(code = 500, message = "Internal Server Error")})
    @RequestMapping(value = "/user/v4", method = RequestMethod.DELETE)
