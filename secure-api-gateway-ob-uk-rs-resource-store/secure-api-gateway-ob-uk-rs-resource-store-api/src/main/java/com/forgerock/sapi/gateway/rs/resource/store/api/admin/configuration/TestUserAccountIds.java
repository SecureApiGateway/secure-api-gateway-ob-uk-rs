 ...
 */
package com.forgerock.sapi.gateway.rs.resource.store.api.admin.configuration;
...
public class TestUserAccountIds {
    ...
    public void setUserAccountIds(Map<String, List<TestAccountId>> userAccountIds) {
        this.userAccountIds = userAccountIds == null || userAccountIds.isEmpty() ? Map.of() : userAccountIds;
    }
