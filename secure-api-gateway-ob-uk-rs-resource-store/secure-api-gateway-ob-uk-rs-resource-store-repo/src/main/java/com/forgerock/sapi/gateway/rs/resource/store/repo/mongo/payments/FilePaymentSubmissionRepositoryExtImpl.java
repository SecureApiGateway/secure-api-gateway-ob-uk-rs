...
public class FilePaymentSubmissionRepositoryExtImpl implements FilePaymentSubmissionRepositoryExt {

    private static final String CONSENT_ID_FIELD_NAME = "filePayment.data.consentId";
    private final FindPaymentByConsentIdQuery findPaymentByConsentIdQuery;

    @Autowired
    public FilePaymentSubmissionRepositoryExtImpl(MongoTemplate mongoTemplate) {
        this.findPaymentByConsentIdQuery = new FindPaymentByConsentIdQuery(mongoTemplate, CONSENT_ID_FIELD_NAME,
                FRFilePaymentSubmission.class);
    }

    @Override
    public Optional<FRFilePaymentSubmission> findByConsentId(String consentId) {
