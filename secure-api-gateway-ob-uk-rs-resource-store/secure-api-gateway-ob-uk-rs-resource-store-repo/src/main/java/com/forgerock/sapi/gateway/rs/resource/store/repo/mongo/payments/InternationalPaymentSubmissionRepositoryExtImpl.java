...
public class InternationalPaymentSubmissionRepositoryExtImpl implements InternationalPaymentSubmissionRepositoryExt {
    ...
    @Autowired
    public InternationalPaymentSubmissionRepositoryExtImpl(MongoTemplate mongoTemplate) {
        this.findPaymentByConsentIdQuery = new FindPaymentByConsentIdQuery(mongoTemplate, CONSENT_ID_FIELD_NAME,
                FRInternationalPaymentSubmission.class);
    }

    @Override
    public Optional<FRInternationalPaymentSubmission> findByConsentId(String consentId) {
