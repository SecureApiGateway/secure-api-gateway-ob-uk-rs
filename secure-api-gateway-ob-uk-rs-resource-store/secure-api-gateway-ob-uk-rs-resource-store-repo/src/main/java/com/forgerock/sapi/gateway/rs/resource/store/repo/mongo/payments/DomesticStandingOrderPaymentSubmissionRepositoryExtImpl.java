...
public class DomesticStandingOrderPaymentSubmissionRepositoryExtImpl implements DomesticStandingOrderPaymentSubmissionRepositoryExt {
    ...
    @Autowired
    public DomesticStandingOrderPaymentSubmissionRepositoryExtImpl(MongoTemplate mongoTemplate) {
        this.findPaymentByConsentIdQuery = new FindPaymentByConsentIdQuery(mongoTemplate,
                CONSENT_ID_FIELD_NAME, FRDomesticStandingOrderPaymentSubmission.class);
    }

    @Override
    public Optional<FRDomesticStandingOrderPaymentSubmission> findByConsentId(String consentId) {
