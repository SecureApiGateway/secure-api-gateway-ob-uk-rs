...
@Api(tags = "v3.1.3-Scheduled-Payments", description = "the scheduled-payments API")
...
public interface ScheduledPaymentsApi {
    ...
    @ApiOperation(value = "Get Account Scheduled Payments", nickname = "getAccountScheduledPayments",
            notes = "Get Scheduled Payments related to an account", response = OBReadScheduledPayment3.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "accounts", description = "Ability to read Accounts information")
            })
    }, tags = {"v3.1.3-AccountScheduledPayments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Account Scheduled Payments successfully retrieved", response = OBReadScheduledPayment3.class),
    ...
    ResponseEntity<OBReadScheduledPayment3> getAccountScheduledPayments(
    ...
    @ApiOperation(value = "Get Scheduled Payments", nickname = "getScheduledPayments", notes = "Get Scheduled Payments", response = OBReadScheduledPayment3.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "accounts", description = "Ability to read Accounts information")
            })
    }, tags = {"v3.1.3-ScheduledPayments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Scheduled Payments successfully retrieved", response = OBReadScheduledPayment3.class),
            @ApiResponse(code = 400, message = "Bad request"),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
