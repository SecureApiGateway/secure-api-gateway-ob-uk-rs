...
public interface InternationalPaymentsApi {
    ...
    @ApiOperation(value = "Create International Payments", nickname = "createInternationalPayments", notes = "", response = OBWriteInternationalResponse4.class, authorizations = {
    ...
    ResponseEntity<OBWriteInternationalResponse4> createInternationalPayments(
    ...
    @ApiOperation(value = "Get International Payments", nickname = "getInternationalPaymentsInternationalPaymentId", notes = "", response = OBWriteInternationalResponse4.class, authorizations = {
    ...
    ResponseEntity<OBWriteInternationalResponse4> getInternationalPaymentsInternationalPaymentId(
