...
@Api(tags = "v3.1.3-Balances", description = "the balances API")
@RequestMapping(value = "/open-banking/v3.1.3/aisp")
public interface BalancesApi {

    @ApiOperation(value = "Get Balances", nickname = "getAccountBalances", notes = "Get Balances related to an account", response = OBReadBalance1.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "accounts", description = "Ability to read Accounts information")
            })
    }, tags = {"v3.1.3-GetAccountBalances",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Account Balances successfully retrieved", response = OBReadBalance1.class),
    ...
    @ApiOperation(value = "Get Balances", nickname = "getBalances", notes = "Get Balances", response = OBReadBalance1.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "accounts", description = "Ability to read Accounts information")
            })
    }, tags = {"v3.1.3-GetBalances",})
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/balances",
            produces = {"application/json; charset=utf-8", "application/jose+jwe"},
            method = RequestMethod.GET)
    ResponseEntity<OBReadBalance1> getBalances(
            @ApiParam(value = "Page number.", required = false, defaultValue = "0")
            @RequestParam(value = "page", defaultValue = "0") int page,
