...
/**
 * Test data factory for International Payment Consent Details
 */
public class InternationalPaymentPlatformIntentTestFactory {

    public static final Gson gson = new Gson();

    public static JsonObject aValidInternationalPaymentPlatformIntent() {
        return aValidInternationalPaymentPlatformIntentBuilder(randomUUID().toString());
    }

    public static JsonObject aValidInternationalPaymentPlatformIntent(String consentId) {
        return aValidInternationalPaymentPlatformIntentBuilder(consentId);
    }

    public static JsonObject aValidInternationalPaymentPlatformIntent(String consentId, OBReadRefundAccountEnum obReadRefundAccountEnum) {
        return aValidOBInternationalPaymentPlatformIntentBuilder(consentId, obReadRefundAccountEnum);
    }

    public static JsonObject aValidInternationalPaymentPlatformIntent(String consentId, String clientId) {
        return aValidInternationalPaymentPlatformIntentBuilder(consentId, clientId);
    }

    public static JsonObject aValidOBInternationalPaymentPlatformIntent(String consentId, String clientId) {
        return aValidOBInternationalPaymentPlatformIntentBuilder(consentId, clientId);
    }

    public static JsonObject aValidInternationalPaymentPlatformIntentBuilder(String consentId) {
        JsonObject consent = new JsonObject();
        consent.addProperty("id", consentId);
        final JsonObject obIntentObject = new JsonObject();
        obIntentObject.add("Data", aValidInternationalPaymentPlatformIntentDataBuilder(consentId, OBReadRefundAccountEnum.YES));
    ...
    public static JsonObject aValidOBInternationalPaymentPlatformIntentBuilder(String consentId, OBReadRefundAccountEnum obReadRefundAccountEnum) {
        JsonObject consent = new JsonObject();
        consent.addProperty("id", consentId);
        final JsonObject obIntentObject = new JsonObject();
        obIntentObject.add("Data", aValidInternationalPaymentPlatformIntentDataBuilder(consentId, obReadRefundAccountEnum));
        consent.add("OBIntentObject", obIntentObject);
        consent.add("resourceOwnerUsername", null);
        consent.addProperty("oauth2ClientId", randomUUID().toString());
        consent.addProperty("oauth2ClientName", "PISP Name");
    ...
    public static JsonObject aValidInternationalPaymentPlatformIntentBuilder(String consentId, String clientId) {
        JsonObject consent = new JsonObject();
        consent.addProperty("id", consentId);
        final JsonObject obIntentObject = new JsonObject();
        obIntentObject.add("Data", aValidInternationalPaymentPlatformIntentDataBuilder(consentId, OBReadRefundAccountEnum.YES));
    ...
    public static JsonObject aValidOBInternationalPaymentPlatformIntentBuilder(String consentId, String clientId) {
        JsonObject consent = new JsonObject();
        consent.addProperty("id", consentId);
        final JsonObject obIntentObject = new JsonObject();
        obIntentObject.add("Data", aValidInternationalPaymentPlatformIntentDataBuilder(consentId, OBReadRefundAccountEnum.YES));
    ...
    public static JsonObject aValidInternationalPaymentPlatformIntentDataBuilder(String consentId, OBReadRefundAccountEnum obReadRefundAccountEnum) {
