...
public class PaymentFundsConfirmationApiControllerTest {
    ...
    public void shouldBeFundsAvailable() {
        ...
        String url = fundsConfirmationUrl(accountId, BALANCE);
    ...
    public void shouldNotBeFundsAvailable() {
        ...
        FRBalance accountBalance = aValidFRBalance(accountId);
        frBalanceRepository.save(accountBalance);
        String url = fundsConfirmationUrl(accountId, "10.01");
    ...
    private String fundsConfirmationUrl(String accountId, String amount) {
        return BASE_URL + port + FUNDS_CONFIRMATION_URI + "/" + accountId + "?amount=" + amount;
    }
