 ...
 */
public class OBRisk1ValidatorV4 extends BaseOBValidator<OBRisk1> {

    private final boolean requirePaymentContextCode;

    /**
     * @param requirePaymentContextCode
     *         boolean flag - whether validation should require that risk's paymentContextCode field is set
     */
    public OBRisk1ValidatorV4(boolean requirePaymentContextCode) {
