...
class OBVRPFundsConfirmationRequestValidatorTest {
    ...
    void testValidConsentPasses() {
        ...
        validateSuccessResult(validator.validate(new OBVRPFundsConfirmationRequestValidator.VRPFundsConfirmationValidationContext(consentId, "Authorised", fundsConfRequest)));
    }
    ...
    void failsWhenConsentIdMismatch() {
        ...
        final ValidationResult<OBError1> validationResult = validator.validate(new OBVRPFundsConfirmationRequestValidator.VRPFundsConfirmationValidationContext("1111", "Authorised", fundsConfRequest));
    ...
    void failsWhenConsentNotAuthorised() {
        ...
        for (final String invalidStatus : invalidStatuses) {
            final ValidationResult<OBError1> validationResult = validator.validate(new OBVRPFundsConfirmationRequestValidator.VRPFundsConfirmationValidationContext(consentId, invalidStatus, fundsConfRequest));
