...
class OBWriteFile2ValidatorTest {
    ...
    private OBWriteFile2ValidationContext createValidationContext() {
        final OBWriteFileConsentResponse4DataStatus status = OBWriteFileConsentResponse4DataStatus.AUTH;
    ...
    void failsWhenInitiationDoesNotMatch() {
        ...
        final OBWriteFile2ValidationContext obWriteFile2ValidationContext = new OBWriteFile2ValidationContext(paymentRequest, consentRequest, OBWriteFileConsentResponse4DataStatus.AUTH.toString());
    ...
    void failsWhenConsentNotAuthorised() {
        final ValidationResult<OBError1> validationResult = validator.validate(createValidationContext(OBWriteFileConsentResponse4DataStatus.AWUP));
