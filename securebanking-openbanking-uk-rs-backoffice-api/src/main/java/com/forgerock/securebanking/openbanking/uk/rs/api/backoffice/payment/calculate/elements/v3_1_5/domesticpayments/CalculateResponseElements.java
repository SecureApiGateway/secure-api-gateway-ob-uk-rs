 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.domesticpayments;
...
@RequestMapping({"/backoffice/v3.1.5/domestic-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteDomesticConsentResponse5> calculateElements(
