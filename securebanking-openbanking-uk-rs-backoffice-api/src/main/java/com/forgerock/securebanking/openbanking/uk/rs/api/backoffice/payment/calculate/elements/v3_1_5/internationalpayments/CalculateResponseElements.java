 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.internationalpayments;
...
@RequestMapping({"/backoffice/v3.1.5/international-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteInternationalConsentResponse6> calculateElements(
