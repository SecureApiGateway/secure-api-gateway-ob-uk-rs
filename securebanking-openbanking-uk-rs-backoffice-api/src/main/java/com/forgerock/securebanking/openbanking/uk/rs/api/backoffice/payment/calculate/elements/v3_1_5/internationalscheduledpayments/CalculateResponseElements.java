 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.internationalscheduledpayments;
...
@RequestMapping({"/backoffice/v3.1.5/international-scheduled-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteInternationalScheduledConsentResponse6> calculateElements(
            @ApiParam(value = "Payment Consent OB object request body", required = true)
            @Valid
            @RequestBody OBWriteInternationalScheduledConsent5 body,
