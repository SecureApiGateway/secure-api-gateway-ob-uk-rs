 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.internationalstandingorders;
...
@RequestMapping({"/backoffice/v3.1.4/international-standing-order-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteInternationalStandingOrderConsentResponse6> calculateElements(
            @ApiParam(value = "Create an Account Access Consents", required = true)
            @Valid
            @RequestBody OBWriteInternationalStandingOrderConsent6 body,
