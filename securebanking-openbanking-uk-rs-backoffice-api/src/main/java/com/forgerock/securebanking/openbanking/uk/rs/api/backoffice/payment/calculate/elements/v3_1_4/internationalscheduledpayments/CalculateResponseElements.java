 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.internationalscheduledpayments;
...
@RequestMapping({"/backoffice/v3.1.4/international-scheduled-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteInternationalScheduledConsentResponse5> calculateElements(
