 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.domesticstandingorders;
...
@RequestMapping({"/backoffice/v3.1.5/domestic-standing-order-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteDomesticStandingOrderConsentResponse6> calculateElements(
