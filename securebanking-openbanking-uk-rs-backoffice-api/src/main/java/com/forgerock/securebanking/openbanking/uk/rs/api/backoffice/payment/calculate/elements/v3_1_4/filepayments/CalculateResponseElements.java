 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.filepayments;
...
@RequestMapping({"/backoffice/v3.1.4/file-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteFileConsentResponse3> calculateElements(
            @ApiParam(value = "Payment Consent OB object request body", required = true)
            @Valid
            @RequestBody OBWriteFileConsent3 body,
