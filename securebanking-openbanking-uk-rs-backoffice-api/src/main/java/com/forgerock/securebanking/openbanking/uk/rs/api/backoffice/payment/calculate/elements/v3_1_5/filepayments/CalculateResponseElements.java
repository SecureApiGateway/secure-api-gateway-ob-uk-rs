 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.filepayments;
...
@RequestMapping({"/backoffice/v3.1.5/file-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteFileConsentResponse4> calculateElements(
