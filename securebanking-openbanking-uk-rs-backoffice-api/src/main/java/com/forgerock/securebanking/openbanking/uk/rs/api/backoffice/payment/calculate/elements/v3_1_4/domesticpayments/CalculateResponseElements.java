 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.domesticpayments;
...
@RequestMapping({"/backoffice/v3.1.4/domestic-payment-consents"})
public interface CalculateResponseElements {
    ...
    OBWriteDomesticConsentResponse4 calculateElements(
