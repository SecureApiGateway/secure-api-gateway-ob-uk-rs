 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_4.domesticscheduledpayments;
...
@RequestMapping({"/backoffice/v3.1.4/domestic-scheduled-payment-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteDomesticScheduledConsentResponse4> calculateElements(
