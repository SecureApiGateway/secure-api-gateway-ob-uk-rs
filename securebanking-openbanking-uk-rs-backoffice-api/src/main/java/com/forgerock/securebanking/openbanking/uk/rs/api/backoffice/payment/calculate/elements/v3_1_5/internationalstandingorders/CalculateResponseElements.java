 ...
 */
package com.forgerock.securebanking.openbanking.uk.rs.api.backoffice.payment.calculate.elements.v3_1_5.internationalstandingorders;
...
@RequestMapping({"/backoffice/v3.1.5/international-standing-order-consents"})
public interface CalculateResponseElements {
    ...
    ResponseEntity<OBWriteInternationalStandingOrderConsentResponse7> calculateElements(
