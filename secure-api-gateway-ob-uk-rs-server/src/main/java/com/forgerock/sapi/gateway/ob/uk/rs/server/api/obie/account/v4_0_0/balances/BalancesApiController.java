...
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.converter.account.FRCashBalanceConverter;
...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.converter.account.FRCashBalanceConverter.toOBReadBalance1DataBalance;
    ...
    public ResponseEntity<OBReadBalance1> getBalances(String authorization, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, String apiClientId, String consentId, int page) throws OBErrorException {
        ...
        return ResponseEntity.ok(new OBReadBalance1()
                .data(new OBReadBalance1Data().balance(balances.getContent().stream()
                        .map(b -> FRCashBalanceConverter.toOBReadBalance1DataBalance(b.getBalance()))
                        .collect(Collectors.toList())))
                .links(PaginationUtilV4.generateLinks(buildGetBalancesUri(), page, totalPage))
                .meta(PaginationUtilV4.generateMetaData(totalPage)));
    }
    ...
    public ResponseEntity<OBReadBalance1> getAccountsAccountIdBalances(String accountId, String authorization, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, String apiClientId, String consentId, int page) throws OBErrorException {
        ...
        return ResponseEntity.ok(new OBReadBalance1()
                .data(new OBReadBalance1Data().balance(balances.getContent().stream()
                        ...
                        .collect(Collectors.toList())))
                .links(PaginationUtilV4.generateLinks(buildGetAccountBalancesUri(accountId), page, totalPage))
                .meta(PaginationUtilV4.generateMetaData(totalPage)));
    }
