 ...
 */
@Component("OBWriteFundsConfirmationResponse1FactoryV4.0.0")
public class OBWriteFundsConfirmationResponse1Factory {

    public OBWriteFundsConfirmationResponse1 create(boolean fundsAvailable,
                                                    String consentId,
                                                    Function<String, Links> fundsConfirmationLinksFactory) {
