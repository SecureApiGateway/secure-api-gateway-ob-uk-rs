...
@Service
@Slf4j
public class AccountDataInternalIdFilterV4 {
    private final boolean showAccountDataInternalIds;

    public AccountDataInternalIdFilterV4(@Value("${rs.data.internal_ids.show:true}") boolean showAccountDataInternalIds) {
