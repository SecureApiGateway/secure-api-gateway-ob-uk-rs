 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.server.api.backoffice.payment.v3_1_4.internationalpayments;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.forgerock.sapi.gateway.ob.uk.common.error.OBErrorResponseException;
import com.forgerock.sapi.gateway.ob.uk.common.error.OBRIErrorResponseCategory;
import com.forgerock.sapi.gateway.ob.uk.common.error.OBRIErrorType;
import com.forgerock.sapi.gateway.ob.uk.rs.backoffice.api.payment.calculate.elements.v3_1_4.internationalpayments.CalculateResponseElements;
...
public class CalculateResponseElementsController implements CalculateResponseElements {
    ...
    public ResponseEntity<OBWriteInternationalConsentResponse5> calculateElements(
        ...
        try {
            OBWriteInternationalConsentResponse5 response = calculateElementsService.calculate(
                    body, intent, request
            );
