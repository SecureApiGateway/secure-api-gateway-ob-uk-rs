...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.converter.account.FRConsentStatusConverter.toOBReadConsentStatusV4;
...
public class OBReadConsentResponseFactory {
    ...
    public OBReadConsentResponse1 buildConsentResponse(AccountAccessConsent consent, Class<?> controllerClass) {
        ...
        return new OBReadConsentResponse1()
                ...
                .links(LinksHelperV4.createAccountAccessConsentsSelfLink(controllerClass, consent.getId()));
    }
