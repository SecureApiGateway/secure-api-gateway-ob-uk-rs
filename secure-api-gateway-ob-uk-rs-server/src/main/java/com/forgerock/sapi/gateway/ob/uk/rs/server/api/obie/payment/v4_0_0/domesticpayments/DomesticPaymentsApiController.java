...
import com.forgerock.sapi.gateway.ob.uk.rs.server.v4.api.obie.payment.services.RefundAccountService;
...
import com.forgerock.sapi.gateway.rs.resource.store.repo.v4.mongo.payments.DomesticPaymentSubmissionRepository;
...
public class DomesticPaymentsApiController implements DomesticPaymentsApi {
    ...
    public DomesticPaymentsApiController(@Qualifier("DomesticPaymentSubmissionRepositoryV4")
            DomesticPaymentSubmissionRepository paymentSubmissionRepository,
            PaymentSubmissionValidator paymentSubmissionValidator,
            @Qualifier("v4.0.0domesticPaymentValidator") OBValidationService<OBWriteDomestic2ValidationContext> paymentValidator,
    ...
    public ResponseEntity<OBWriteDomesticResponse5> createDomesticPayments(String authorization, String xIdempotencyKey, String xJwsSignature,
                                                                           ...
                                                                           String apiClientId, HttpServletRequest request) throws OBErrorResponseException, OBErrorException {
    ...
    @Override
    public ResponseEntity getDomesticPaymentsDomesticPaymentIdPaymentDetails(String domesticPaymentId, String authorization,
                                                                             String xFapiAuthDate, String xFapiCustomerIpAddress,
                                                                             String xFapiInteractionId, String xCustomerUserAgent,
                                                                             String apiClientId, HttpServletRequest request) {
        Optional<FRDomesticPaymentSubmission> isPaymentSubmission = paymentSubmissionRepository.findById(domesticPaymentId);
                                        ...
                                        new OBWritePaymentDetails1()
                                                ...
                                                .statusDetail(
                                                        new OBWritePaymentDetails1StatusDetail()
                                                                ...
                                                                .status(FRPaymentDetailsStatusConverter.toOBWritePaymentDetails1StatusDetailStatus(frPaymentSubmission.getStatus().getValue()))
                                                                ...
                                                                .statusReasonDescription(OBWritePaymentDetails1PaymentStatusStatus.PDNG.getValue())
                                                )
                                )
