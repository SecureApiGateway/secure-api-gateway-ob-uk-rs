...
@Service("v3.1.10DefaultAccountResourceAccessService")
public class DefaultAccountResourceAccessService implements AccountResourceAccessService {
    ...
    public DefaultAccountResourceAccessService(@Qualifier("v3.1.10RestAccountAccessConsentStoreClient") AccountAccessConsentStoreClient consentStoreClient) {
