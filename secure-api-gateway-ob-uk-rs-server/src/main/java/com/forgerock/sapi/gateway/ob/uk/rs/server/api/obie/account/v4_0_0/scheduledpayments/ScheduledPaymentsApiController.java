...
import com.forgerock.sapi.gateway.ob.uk.rs.obie.api.account.v4_0_0.scheduledpayments.ScheduledPaymentsApi;
...
import com.forgerock.sapi.gateway.rs.resource.store.repo.mongo.v4.accounts.scheduledpayments.FRScheduledPaymentRepository;
...
import uk.org.openbanking.datamodel.v4.account.OBReadScheduledPayment3Data;

import java.util.List;
import java.util.stream.Collectors;

import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.converter.payment.FRScheduledPaymentConverter.toOBScheduledPayment3;
import static org.springframework.hateoas.server.mvc.WebMvcLinkBuilder.linkTo;

@Controller("ScheduledPaymentsApiV4.0.0")
@Slf4j
public class ScheduledPaymentsApiController implements ScheduledPaymentsApi {
    ...
    @Override
    public ResponseEntity<OBReadScheduledPayment3> getScheduledPayments(String authorization, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, String apiClientId, String consentId, int page) throws OBErrorException {
    ...
    @Override
    public ResponseEntity<OBReadScheduledPayment3> getAccountsAccountIdScheduledPayments(String accountId, String authorization, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, String apiClientId, String consentId, int page) throws OBErrorException {
    ...
    private ResponseEntity<OBReadScheduledPayment3> packageResponse(int page, String httpUrl, Page<FRScheduledPayment> scheduledPayments) {
        ...
        return ResponseEntity.ok(new OBReadScheduledPayment3().data(new OBReadScheduledPayment3Data().scheduledPayment(
                ...
                .links(PaginationUtilV4.generateLinks(httpUrl, page, totalPages))
