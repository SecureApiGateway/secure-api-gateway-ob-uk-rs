...
import static com.forgerock.sapi.gateway.ob.uk.rs.server.common.util.link.LinksHelper.createCallbackUrlsResourcesLink;
import static com.forgerock.sapi.gateway.ob.uk.rs.server.common.util.link.LinksHelper.createCallbackUrlsSelfLink;
...
public class CallbackUrlsResponseUtil {
    ...
    public static OBCallbackUrlsResponse1 packageResponse(List<FRCallbackUrl> frCallbackUrls,
        ...
        List<OBCallbackUrlResponseData1> filteredUrls = frCallbackUrls.stream()
                .filter(it -> ResourceVersionValidator.isAccessToResourceAllowed(apiVersion, OBVersion.fromString(it.getCallbackUrl().getVersion())))
