...
public class FakeDataApiController implements FakeDataApi {
    ...
    private final Map<String, List<TestUserAccountIds.TestAccountId>> userAccountIds;
    ...
    Supplier<String> createAccountIdSupplier(String username) {
        ...
        final List<TestUserAccountIds.TestAccountId> accountIds = userAccountIds.get(username);
        if (accountIds == null) {
