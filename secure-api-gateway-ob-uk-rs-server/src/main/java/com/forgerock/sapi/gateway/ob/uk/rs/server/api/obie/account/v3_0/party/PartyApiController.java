...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.converter.account.FRPartyConverter.toOBParty1;
...
public class PartyApiController implements PartyApi {
    ...
    @Override
    public ResponseEntity<OBReadParty1> getParty(String authorization,
                                                 DateTime xFapiCustomerLastLoggedTime,
                                                 String xFapiCustomerIpAddress,
                                                 String xFapiInteractionId,
                                                 String xCustomerUserAgent,
