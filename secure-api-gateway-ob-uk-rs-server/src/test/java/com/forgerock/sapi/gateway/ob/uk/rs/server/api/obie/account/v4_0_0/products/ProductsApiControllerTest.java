...
import com.forgerock.sapi.gateway.ob.uk.rs.server.api.obie.account.v4_0_0.products.ProductsApiController;
...
public class ProductsApiControllerTest {
    ...
    private static final String ACCOUNT_PRODUCT_URI = "/open-banking/v4.0.0/aisp/accounts/{AccountId}/product";
    private static final String PRODUCTS_URI = "/open-banking/v4.0.0/aisp/products";
