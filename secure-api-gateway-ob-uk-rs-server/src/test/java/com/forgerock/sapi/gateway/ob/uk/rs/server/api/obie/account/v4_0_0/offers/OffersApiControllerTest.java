...
import com.forgerock.sapi.gateway.ob.uk.rs.server.api.obie.account.v4_0_0.offers.OffersApiController;
...
public class OffersApiControllerTest {
    ...
    private static final String ACCOUNT_OFFERS_URI = "/open-banking/v4.0.0/aisp/accounts/{AccountId}/offers";
    private static final String OFFERS_URI = "/open-banking/v4.0.0/aisp/offers";
