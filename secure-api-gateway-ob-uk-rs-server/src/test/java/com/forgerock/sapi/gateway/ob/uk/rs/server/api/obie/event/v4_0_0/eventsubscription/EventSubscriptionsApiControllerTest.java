...
import static com.forgerock.sapi.gateway.uk.common.shared.api.meta.obie.OBVersion.v4_0_0;
...
public class EventSubscriptionsApiControllerTest {
    ...
    private static final String EVENT_SUBSCRIPTIONS_URI = "/open-banking/v4.0.0/event-subscriptions";

    @LocalServerPort
    protected int port;

    @Autowired
    protected EventSubscriptionsRepository eventSubscriptionsRepository;
    ...
    public void shouldCreateEventSubscription() {
        ...
        headers.add("x-jws-signature","dummy");
        ...
        OBEventSubscriptionResponse1Data responseData = Objects.requireNonNull(response.getBody()).getData();
    ...
    private OBEventSubscription1 aValidOBEventSubscription1() {
        return new OBEventSubscription1()
                .data(new OBEventSubscription1Data()
                        ...
                        .version(v4_0_0.getCanonicalName())
