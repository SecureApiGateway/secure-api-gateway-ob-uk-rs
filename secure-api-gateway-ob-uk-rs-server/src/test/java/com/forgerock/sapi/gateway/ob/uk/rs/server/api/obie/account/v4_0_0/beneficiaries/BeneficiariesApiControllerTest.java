...
import com.forgerock.sapi.gateway.ob.uk.rs.server.api.obie.account.v4_0_0.beneficiaries.BeneficiariesApiController;
...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.testsupport.v4.account.FRAccountBeneficiaryTestDataFactory.aValidFRAccountBeneficiary;
...
public class BeneficiariesApiControllerTest {
    ...
    private static final String ACCOUNT_BENEFICIARIES_URI = "/open-banking/v4.0.0/aisp/accounts/{AccountId}/beneficiaries";
    private static final String BENEFICIARIES_URI = "/open-banking/v4.0.0/aisp/beneficiaries";
