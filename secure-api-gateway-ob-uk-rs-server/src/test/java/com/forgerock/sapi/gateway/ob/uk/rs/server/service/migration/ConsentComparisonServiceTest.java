...
public class ConsentComparisonServiceTest {
    ...
    void testDoesRequestMatchConsent_BothNull() {
        boolean result = consentComparisonService.doFieldsMatch(null, null);
        assertThat(result).isFalse();
    }

/*    @Test
    void testDoesRequestMatchConsent_RequestIsNull() {
        DomesticVRPConsent consent = new DomesticVRPConsent();
        boolean result = consentComparisonService.doFieldsMatch(null, consent);
        assertThat(result).isFalse();
    }*/

    @Test
    void testDoesRequestMatchConsent_ConsentIsNull() {
        OBDomesticVRPConsentRequest request = new OBDomesticVRPConsentRequest();
        boolean result = consentComparisonService.doFieldsMatch(request, null);
        assertThat(result).isFalse();
    }
...
/*    @Test
    void testDoesRequestMatchConsent_NotEqual() {
        OBDomesticVRPConsentRequest request = new OBDomesticVRPConsentRequest();
        DomesticVRPConsent consent = new DomesticVRPConsent();
        boolean result = consentComparisonService.doFieldsMatch(request, consent);
        assertThat(result).isFalse();
    }*/
}
