...
public class FundsConfirmationsApiControllerTest {
    ...
    public void shouldCreateFundsConfirmation() {
        ...
        HttpEntity<OBFundsConfirmation1> request = new HttpEntity<>(fundsConfirmation, HttpHeadersTestDataFactory.requiredFundsHttpHeaders(fundsConfirmationsUrl(), accountId));
    ...
    public void shouldGetFundsConfirmation() {
        // Given
        OBFundsConfirmation1 fundsConfirmation = aValidOBFundsConfirmation1();
        HttpHeaders headers = HttpHeadersTestDataFactory.requiredFundsHttpHeaders(fundsConfirmationsUrl(), accountId);
