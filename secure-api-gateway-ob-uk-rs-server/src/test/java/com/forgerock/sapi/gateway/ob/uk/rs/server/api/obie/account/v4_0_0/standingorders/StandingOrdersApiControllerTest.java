...
import com.forgerock.sapi.gateway.ob.uk.rs.server.api.obie.account.v4_0_0.standingorders.StandingOrdersApiController;
...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.testsupport.v4.account.FRStandingOrderDataTestDataFactory.aValidFRStandingOrderData;
...
public class StandingOrdersApiControllerTest {
    ...
    private static final String ACCOUNT_STANDING_ORDERS_URI = "/open-banking/v4.0.0/aisp/accounts/{AccountId}/standing-orders";
    private static final String STANDING_ORDERS_URI = "/open-banking/v4.0.0/aisp/standing-orders";
