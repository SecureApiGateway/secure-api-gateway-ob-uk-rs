...
/**
 * Unit test for {@link DomesticScheduledPaymentConsentValidation}
 */
public class DomesticScheduledPaymentConsentValidationTest {
    private PaymentConsentValidation validation;
    private OBWriteDomesticScheduledConsent3 consent3;

    @BeforeEach
    public void setup() {
        validation = new DomesticScheduledPaymentConsentValidation();
        consent3 = aValidOBWriteDomesticScheduledConsent3();
    }

    private static Stream<Arguments> provideConsent() {
        return Stream.of(
                Arguments.arguments(aValidOBWriteDomesticScheduledConsent3()),
                Arguments.arguments(aValidOBWriteDomesticScheduledConsent4())
        );
    }
