...
import static uk.org.openbanking.testsupport.v3.payment.OBWriteInternationalScheduledConsentTestDataFactory.aValidOBWriteInternationalScheduled3DataInitiation;
...
import com.forgerock.sapi.gateway.ob.uk.rs.server.common.util.v3_1_10.PaymentsUtils;
...
public class InternationalScheduledPaymentApiControllerTest {
    ...
    public void testIdempotentSubmission() {
        ...
        ResponseEntity<OBWriteInternationalScheduledResponse6> secondSubmissionResponse = restTemplate.postForEntity(paymentsUrl(), request, OBWriteInternationalScheduledResponse6.class);
