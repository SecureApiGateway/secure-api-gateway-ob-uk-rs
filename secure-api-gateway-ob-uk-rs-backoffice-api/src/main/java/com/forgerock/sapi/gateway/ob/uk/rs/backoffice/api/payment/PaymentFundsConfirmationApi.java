 ...
 */
package com.forgerock.sapi.gateway.ob.uk.rs.backoffice.api.payment;

import com.forgerock.sapi.gateway.ob.uk.common.datamodel.payment.FRFundsConfirmationResponse;
...
public interface PaymentFundsConfirmationApi {
    ...
    @ApiOperation(value = "Get Payment Funds Confirmation",
            nickname = "getPaymentFundsConfirmation",
            notes = "", response = FRFundsConfirmationResponse.class,
            tags = {"Payment Funds Confirmation",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Payment Funds Confirmation", response = FRFundsConfirmationResponse.class),
